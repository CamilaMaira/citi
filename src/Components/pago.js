  ...
  useEffect(() => {
    voiceCommands();
     ...
     return(
      ...
      <div className="PagoWhite">

<div className="iconAgua">
<svg className="AguaIcono" width="49" height="67" viewBox="0 0 49 67" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<svg className="CamaraI" width="55" height="51" viewBox="0 0 55 51" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<svg className="FormularioI" width="82" height="52" viewBox="0 0 82 52" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<button className="BtnFormulario">LLenar formulario</button>
</div>
      </div>
        </div>
    )
